...
/**
 * REST controller for managing {@link com.nmn.bloom.domain.Cabinet}.
 */
@RestController
@RequestMapping("/api")
public class CabinetResource {
    ...
    public CabinetResource(CabinetService cabinetService, CabinetRepository cabinetRepository) {
    ...
    public ResponseEntity<Cabinet> updateCabinet(@PathVariable(value = "id", required = false) final Long id, @RequestBody Cabinet cabinet)
        ...
        Cabinet result = cabinetService.update(cabinet);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<Cabinet> partialUpdateCabinet(
        ...
        Optional<Cabinet> result = cabinetService.partialUpdate(cabinet);
