...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './product-directory.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTDIRECTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTDIRECTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTDIRECTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTDIRECTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTDIRECTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTDIRECTORY actions', async () => {
      const expectedActions = [
        {
