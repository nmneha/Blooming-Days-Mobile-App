...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cabinet.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CABINET_LIST actions', async () => {
    ...
    it('dispatches FETCH_CABINET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CABINET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CABINET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CABINET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CABINET actions', async () => {
      const expectedActions = [
        {
