...
import com.nusera.bloom.repository.ProductDirectoryRepository;
...
/**
 * REST controller for managing {@link com.nusera.bloom.domain.ProductDirectory}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProductDirectoryResource {
    ...
    public ProductDirectoryResource(ProductDirectoryRepository productDirectoryRepository) {
    ...
    public ResponseEntity<ProductDirectory> createProductDirectory(@RequestBody ProductDirectory productDirectory)
        ...
        ProductDirectory result = productDirectoryRepository.save(productDirectory);
    ...
    public ResponseEntity<ProductDirectory> partialUpdateProductDirectory(
        ...
        Optional<ProductDirectory> result = productDirectoryRepository
    ...
    public ResponseEntity<ProductDirectory> getProductDirectory(@PathVariable Long id) {
        ...
        Optional<ProductDirectory> productDirectory = productDirectoryRepository.findOneWithEagerRelationships(id);
