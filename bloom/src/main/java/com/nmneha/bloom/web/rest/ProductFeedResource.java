...
/**
 * REST controller for managing {@link com.nmneha.bloom.domain.ProductFeed}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProductFeedResource {
    ...
    public List<ProductFeed> getAllProductFeeds(@RequestParam(required = false) String filter) {
        ...
        return productFeedRepository.findAll();
    }
    ...
    public ResponseEntity<ProductFeed> getProductFeed(@PathVariable Long id) {
        ...
        Optional<ProductFeed> productFeed = productFeedRepository.findById(id);
