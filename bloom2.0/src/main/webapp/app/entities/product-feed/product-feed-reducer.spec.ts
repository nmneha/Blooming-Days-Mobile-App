...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTFEED_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRODUCTFEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRODUCTFEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRODUCTFEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTFEED actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRODUCTFEED actions', async () => {
      const expectedActions = [
        {
