...
export const CommentsDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="bloomApp.comments.delete.question">
        <Translate contentKey="bloomApp.comments.delete.question" interpolate={{ id: commentsEntity.id }}>
