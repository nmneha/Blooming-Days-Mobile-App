...
import com.nmneha.bloom.domain.Comments;
import com.nmneha.bloom.repository.CommentsRepository;
...
/**
 * REST controller for managing {@link com.nmneha.bloom.domain.Comments}.
 */
@RestController
@RequestMapping("/api")
@Transactional
