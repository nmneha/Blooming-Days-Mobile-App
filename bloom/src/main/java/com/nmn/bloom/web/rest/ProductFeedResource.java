...
/**
 * REST controller for managing {@link com.nmn.bloom.domain.ProductFeed}.
 */
@RestController
@RequestMapping("/api")
public class ProductFeedResource {
    ...
    public ProductFeedResource(ProductFeedService productFeedService, ProductFeedRepository productFeedRepository) {
    ...
    public ResponseEntity<ProductFeed> createProductFeed(@RequestBody ProductFeed productFeed) throws URISyntaxException {
        ...
        ProductFeed result = productFeedService.save(productFeed);
    ...
    public ResponseEntity<ProductFeed> updateProductFeed(
        ...
        ProductFeed result = productFeedService.update(productFeed);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<ProductFeed> partialUpdateProductFeed(
        ...
        Optional<ProductFeed> result = productFeedService.partialUpdate(productFeed);
    ...
    public List<ProductFeed> getAllProductFeeds(
        ...
        if ("cabinet-is-null".equals(filter)) {
            ...
            return productFeedService.findAllWhereCabinetIsNull();
        }
        log.debug("REST request to get all ProductFeeds");
        return productFeedService.findAll();
    }
    ...
    public ResponseEntity<ProductFeed> getProductFeed(@PathVariable Long id) {
        ...
        Optional<ProductFeed> productFeed = productFeedService.findOne(id);
