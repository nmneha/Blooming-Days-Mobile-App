package com.nusera.bloom.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.nusera.bloom.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.nusera.bloom.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.nusera.bloom.domain.ProductDirectory.class.getName() + ".cabinets");
